...

{
   ...
   echo "<h2>Sorry, that Screen name is already taken.</h2><br>\n";
...

{
...

   {
    /*If the INSERT statement is successful, the program creates a new variable in the session cookie using the code:*/
      ...
      echo "<h2>Congratulations! Your registration request has been approved, Your Screen name is $userid you are now logged in!</h2>\n";
