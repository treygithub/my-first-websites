<div class="container">
    <form class="contact" action="index.php" method="post">
        <h3>Register at AirART2goBlog</h3>
        <h4>To share your questions and comments with others</h4>
        ...
        <fieldset>
        <input type="password" placeholder="Type Password Here:" name="password" title="Please type password here..." required>
        </fieldset>

        <br />

        <fieldset>
        <input type="password" placeholder="Type Password Here:" name="password2" title="Please type password here..." required>
        </fieldset>      
