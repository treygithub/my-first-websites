...
/* $query results are stored into $results variable */
    ...
    if ($result)
       ...
       echo "<h2>Trey has been notified of your request and recieved your Message! Being the wonderful and extremly amazing not to mention handsome guy that he is, you should recieve a responce soon as humanly posible... </h2><br><hr/>\n";
